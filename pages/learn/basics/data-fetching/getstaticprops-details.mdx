...
You can get in-depth information about `getStaticProps` on <Link href="/docs/[...slug]" as="/docs/basic-features/data-fetching"><a>our documentation</a></Link>. But here are some essential information you should know about `getStaticProps`.
