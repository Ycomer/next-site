...
> Again, You can get in-depth information about `getStaticProps` and `getServerSideProps` on <Link href="/docs/[...slug]" as="/docs/basic-features/data-fetching"><a>our documentation</a></Link>.
