...
Finally, in `[id].js`, we’ll import this function:
...
- [localhost:3000/posts/dps](http://localhost:3000/posts/dps)
- [localhost:3000/posts/pre-rendering](http://localhost:3000/posts/pre-rendering)
...
<Image
  ...
  alt="Blog Data"
  oversize={false}
  src="/static/images/learn/data-fetching/blog-data-post-page.png"
  width={948 / 2}
  height={738 / 2}
/>

Great! We successfully generated dynamic pages. Again, here’s the graphical summary of what we’ve done:
