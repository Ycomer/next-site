...
This is beyond the scope of our lessons, but you can learn more about `fallback: true` on <Link href="/docs/[...slug]" as="/docs/basic-features/data-fetching#fallback-pages"><a>our documentation</a></Link>.
