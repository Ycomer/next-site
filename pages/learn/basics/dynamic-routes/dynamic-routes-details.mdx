...
You can get in-depth information about dynamic routes on our documentation:
...
But here are some essential information you should know about dynamic routes.
...
This is out of the scope of our lessons, but you can learn more about `fallback: true` on <Link href="/docs/[...slug]" as="/docs/basic-features/data-fetching#fallback-pages"><a>our documentation</a></Link>.
...
In the next and the final lesson, we’ll talk about the API Routes feature for Next.js.
