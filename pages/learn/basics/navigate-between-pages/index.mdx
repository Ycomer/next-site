...
Let's explore how to add more pages and do routing in Next.js.
...
> If you’re looking for detailed documentation on Next.js routing, take a look at the <Link href="/docs/[...slug]" as="/docs/routing/introduction"><a>documentation</a></Link>.
